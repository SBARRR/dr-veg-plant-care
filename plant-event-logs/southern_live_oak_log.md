...
- Watering status: Last watered on 2026-06-08 with about 1 gallon after the media no longer felt cool. As of 2026-06-11, soil remains moist and also received approximately one hour of light rain on 2026-06-11. No additional watering was done.
...
- Last soil change: 2026-05-26; major soil change during ground-to-pot transplant, with roughly 90% new soil and 10% original ground soil preserved around the root ball.
...
- Latest check-in notes: On 2026-06-11, user reported nothing new with the Southern Live Oak. Overall condition looks the same. Soil remains moist and the plant received approximately one hour of light rain. Continue avoiding additional watering while soil remains moist.
...
- Details: User suspected the Southern Live Oak’s normal porch position receives less direct sun than previously estimated because the tree is tall and positioned closer to the sliding glass door than the other porch plants. User moved the oak just outside the porch on the same side of the house for a temporary sun-position test, then returned it to its normal porch spot afterward.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: Temporary light-position test only; do not treat this as a confirmed long-term placement yet. No watering was done because under-mulch soil still felt slightly cool/moist earlier today. User is actively scouting a brighter long-term position while avoiding extra stress, fertilizer, pruning, or repotting.
  <!-- Result/status after the event, expected follow-up, or "TBD" if the outcome is not known yet. -->

### 2026-06-07 — Under-Mulch Moisture Check / Moderate Crispy Leaf Drop

- Summary: Under-mulch soil is drying but still slightly cool/moist; about 15 brown crispy leaves were found and removed from the mulch surface.
  <!-- One-line summary of what happened. -->

- Details: User reported uncertainty about judging soil moisture by finger check. It has been about 7 days since the last watering. User checked below the mulch and the root-zone soil still feels somewhat moist/damp, though definitely less moist than before and only slightly cool. User also found about 15 brown crispy leaves sitting on top of the mulch, likely accumulated over the past couple days, and removed them from the mulch surface.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: No watering today while the under-mulch root-zone soil still feels slightly cool/moist. Continue checking under the mulch 2–3 inches down, or use a wooden skewer/chopstick test for a clearer dry/wet read. Water deeply to runoff only when the top 2–3 inches under the mulch feel dry and the pot feels lighter. Keep fallen leaf debris off the mulch surface and monitor whether leaf drop accelerates, new growth becomes limp, orange powdery spots spread, or browning spreads across most of the canopy.
  <!-- Result/status after the event, expected follow-up, or "TBD" if the outcome is not known yet. -->
...
- Summary: Soil still moist but not soaked; new growth posture stable or slightly improved.
  <!-- One-line summary of what happened. -->

- Details: User reports soil still feels moist but not soaked. Previously droopy tips have not drooped back down and may look slightly improved. Checked browning leaves are stiff/crisp rather than soft or mushy.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: Continue holding water for now while soil remains moist. Monitor posture, browning spread, and soil dry-down.
  <!-- Result/status after the event, expected follow-up, or "TBD" if the outcome is not known yet. -->
...
- Summary: First log check-in after transplant; tree appears stressed with new leaf browning and slight drooping of new growth/twig tips.
  <!-- One-line summary of what happened. -->

- Details: User noticed some leaves beginning to brown yesterday and reports that new growth and branch tips appeared slightly droopy from the transplant day through yesterday. User is unsure whether the drooping was already present before digging the tree from the ground.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: Monitor closely for transplant stress, especially whether browning spreads, new growth continues drooping, or the tree stabilizes.
  <!-- Result/status after the event, expected follow-up, or "TBD" if the outcome is not known yet. -->

### 2026-05-31 — Watering

- Summary: Watered until runoff drained from the bottom of the pot.
  <!-- One-line summary of what happened. -->

- Details: Amount was roughly 0.5 gallon or slightly more, but definitely less than 1 gallon. Watering stopped once drainage came out the bottom.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: Drainage confirmed; monitor drying behavior and avoid overwatering while the tree is recovering from transplant/root disturbance.
  <!-- Result/status after the event, expected follow-up, or "TBD" if the outcome is not known yet. -->

### 2026-05-26 — Transplant

- Summary: Dug Southern Live Oak from the ground and moved it into the current 3-gallon planter.
  <!-- One-line summary of what happened. -->

- Details: User preserved as much soil around the root ball as possible, but final potting media was roughly 90% new soil and 10% original ground soil. Outward roots were accidentally damaged during digging. Taproot was intentionally cut roughly 1–1.5 feet below soil level because the full taproot could not be dug out. After potting, user performed a full soak that took about 2 gallons before water drained from the bottom.
  <!-- Useful specifics, such as amount of water, product used, symptom observed, action taken, context, or uncertainty. -->

- Outcome: Major transplant/root disturbance logged; tree should be monitored for transplant shock, leaf browning, drooping new growth, and recovery/stabilization over the next several weeks.